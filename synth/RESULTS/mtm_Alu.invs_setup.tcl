...
source /student/ptokarczyk/PPCU_VLSI/VLSI_2019_project-master/synth/RESULTS/mtm_Alu.flowkit_settings.tcl

source /student/ptokarczyk/PPCU_VLSI/VLSI_2019_project-master/synth/RESULTS/mtm_Alu.invs_init.tcl
...
# Mode Setup
###########################################################
source /student/ptokarczyk/PPCU_VLSI/VLSI_2019_project-master/synth/RESULTS/mtm_Alu.mode
...
if {[is_attribute -obj_type port original_name] && [is_attribute -obj_type pin original_name] && [is_attribute -obj_type pin is_phase_inverted]} {
  source /student/ptokarczyk/PPCU_VLSI/VLSI_2019_project-master/synth/RESULTS/mtm_Alu.wnm_attrs.tcl
}
