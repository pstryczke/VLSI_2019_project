...
########################################################
source /student/ptokarczyk/PPCU_VLSI/VLSI_2019_project-master/synth/RESULTS/mtm_Alu.genus_init.tcl
read_metric -id current /student/ptokarczyk/PPCU_VLSI/VLSI_2019_project-master/synth/RESULTS/mtm_Alu.metrics.json

source /student/ptokarczyk/PPCU_VLSI/VLSI_2019_project-master/synth/RESULTS/mtm_Alu.g
...
if {$_slk_ != "1256.0"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1256.0,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
if {"[string_representation [::legacy::get_attribute slack_by_mode design:mtm_Alu]]" != "{{mode:mtm_Alu/WC_av 1256.0}}"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack_by_mode: {{mode:mtm_Alu/WC_av 1256.0}}  current slack_by_mode: [string_representation [::legacy::get_attribute slack_by_mode design:mtm_Alu]]"
}
# tns
...
if {$_cell_area_ != "53180"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 53180,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "23629"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 23629,  current net area: $_net_area_"
}
unset _net_area_
